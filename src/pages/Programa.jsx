...
export default function Programa() {
  ...
  const variarCorreo = () => {
    if (
      grado.nombre == "Doctorado en Neurociencias" ||
      grado.nombre == "Doctorado en Ciencias de la Salud" ||
      grado.nombre == "Doctorado en Medicina" ||
      grado.nombre == "Doctorado en Enfermería"
    ) {
      return "upgdoctorado.medicina@unmsm.edu.pe";
    } else {
      return upg.contactos[2].link;
    }
  };

  return (
    <>
      {modalOpen && <DataModal handleClose={close}></DataModal>}
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap justify-around my-8">
              ...
              >
                ...
                >
                  <div className="px-3 py-2 bg-red-800 border-b border-red-800 rounded-t-lg">
              ...
              <a
                ...
                href={
                  "https://wa.me/" +
                  grado.wsp[0].link.slice(1).replace(/ /g, "")
                }
                target="_blank"
                onMouseEnter={() => {
                  setPop2(true);
